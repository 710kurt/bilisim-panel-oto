...
##############################################################################################
# Tek Sistem İle Kontrol Panel Kurulum Created: RootRazor
# Açık Kaynak Olarak Paylaştım İstek Gelirse 'C' Olarak Kodlarım İstediğiniz Gibi Düzenliyebilirsiniz.
# İletisim: telegram: rootrazor & github.com/rootrazor
# turkharekat.com
##############################################################################################
...
#  / \ / \ / \ / \ / \ / \ / \        --------------------------------${renk}
# ( R | A | Z | O | R | T | R |${mavim}      ¦         TurkHarekat.com        ¦${beyaz}
#  \_/ \_/ \_/ \_/ \_/ \_/ \_/        --------------------------------
"${beyaz}
	echo -e "\033[1;33m \033[0;36m                                                             \033[1;33m \033[0m"
	echo -e "\033[1;33m# \033[0;36m=>  TurkHarekat Centos 6,7 Web Panel Kurulumu \033[0m                       \033[1;33m \033[0m"
	...
	echo -e "\033[1;33m######################################################################\033[1;32m \033[0m"
	echo -e "\033[1;31m1)  VestaCP Kur\033[0m"
...
echo -e "\033[0;32m#\033[0m\033[1;31m Sunucu Özellikleri;\033[0m"
free -m | awk 'NR==2{printf "\033[0;32m#\033[0m\033[1;37m RAM Kullanımı:\033[0m \033[1;31m%s/%sMB (%.2f%%)\033[0m \n", $3,$2,$3*100/$2 }'
df -h | awk '$NF=="/"{printf "\033[0;32m#\033[0m\033[1;37m Disk Kullanımı: \033[1;31m%d/%dGB (%s)\n\033[0m", $3,$2,$5}'
top -bn1 | grep load | awk '{printf "\033[0;32m#\033[0m\033[1;37m CPU Load: \033[1;31m%.2f\n\033[0m", $(NF-2)}' 
echo -e "\033[0;32m#######################################################\033[0m"
read secenek
